document.addEventListener("DOMContentLoaded", () => {
  ...
  async function validarDatos() {
    ...
    if (response.length == 0) {
      ...
      showToast("La empresa ya se encuentra registrado", "info", "INFO");
      addCliente(false);
    }
  }
  ...
  $("#registrar-empresa").addEventListener("submit", async (event) => {
    ...
    if (await showConfirm("¿Desea registrar la empresa?", "Empresas")) {
      ...
      showToast("No es posible registrar", "info","INFO")
    }
  });
