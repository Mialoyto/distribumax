    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form method="POST" action="../../controller/tipopromociones.controller.php?operation=addTipoPromocion" id="form-promocion" autocomplete="off">
...
<script src="../../js/promociones/registrar.js"> </script>
